 ...
 */
class OaiPmhStaticRepository_Identifier_ShortName extends OaiPmhStaticRepository_Identifier_Abstract
{
    /**
    ...
    protected function _create($data)
    {
        ...
        foreach ($data as $resource) {
            ...
            if (!isset($record['name'])) {
                throw new OaiPmhStaticRepository_BuilderException(__('A name is missing for record %s.', key($data[0])));
            }

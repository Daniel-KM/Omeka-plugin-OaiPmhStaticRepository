...
<div id="primary">
    ...
    <?php if (!empty($folder)): ?>
        ...
        <?php else: ?>
            <p><?php echo __('This static repository has no message yet.'); ?></p>
        <?php endif; ?>
    <?php else: ?>
        <p><?php echo __('This is not a static repository.'); ?></p>
    <?php endif; ?>
    <p><?php echo __('Back to %sOAI-PMH Static Repositories%s.',
        '<a href="' . ADMIN_BASE_URL . '/oai-pmh-static-repository">', '</a>'); ?>
    </p>
</div>
